// By Satoki Mizoguchi
// https://github.com/mizo0203/super-mizo-m5stickC
//
...
void game_loop() {
  ...
  while (1) {
    ...
    while( millis() > next_game_tick && loops < MAX_FRAMESKIP) {
      if(landed && digitalRead(M5_BUTTON_HOME) == LOW){
        landed = false;
...
void game_start() {
  ...
  M5.Lcd.setCursor( TFTW2-13, TFTH2 - 6);
  M5.Lcd.println("SUPER");
  M5.Lcd.setTextSize(1);
